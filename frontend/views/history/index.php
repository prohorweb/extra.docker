...
<section class="nav-section">
    <div class="container">
        <div class="nav-section__row">
            ...
            <div class="nav-section__item active"><a href="#">истории успеха</a></div>
        ...
        <select name="" id="" class="nav-section__select select-noborder" onchange="if (this.value) window.location.href=this.value">
            ...
            <option value="#" selected>истории успеха</option>
...
<main class="main-section main-section--team-blog team-blog team-blog--doposle">
    <div class="container container--min">

        <h1 class="team-blog__title title-h1">Истории успеха клуба<br class="none visible-sm"> <?= $this->params['club']->title ?></h1>

        <div class="team-blog__wrap">
            <div class="team-blog__list row">
                <?= ListView::widget([
